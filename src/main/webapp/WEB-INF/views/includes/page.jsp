...
.page_next { background: url("/WEB-INF/views/include/img/page_next.jpg") center no-repeat; }
.page_last { background: url("/WEB-INF/views/include/img/page_last.jpg") center no-repeat; }
.page_prev { background: url("/WEB-INF/views/include/img/page_prev.jpg") center no-repeat; }
.page_first { background: url("/WEB-INF/views/include/img/page_first.jpg") center no-repeat; }
